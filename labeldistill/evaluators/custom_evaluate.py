...
from labeldistill.evaluators.evalonly.nuscenes.eval.common.loaders import load_gt_only_first
...
class DetectionEval:
    ...
    def __init__(self,
        ...
        self.gt_boxes = load_gt_only_first(self.nusc, self.eval_set, DetectionBox, verbose=verbose)
